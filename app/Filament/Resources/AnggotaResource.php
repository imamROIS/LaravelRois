...
class AnggotaResource extends Resource
{
    ...
    ->required(),
                ...
                Textarea::make('Jenis_Produk')->label('Jenis Produk')->required(),
            ...
            Forms\Components\Section::make('Keuangan')->schema([
                ...
                TextInput::make('Jumlah_Cabang')->label('Jumlah Cabang')->numeric()->minValue(1) ->default(1),
            ]),
            ...
            Forms\Components\Section::make('Dokumen Pendukung')->schema([
                ...
                Forms\Components\Section::make('NIB') ->schema([
                    TextInput::make('NIB')->label('Nomor Induk Berusaha (NIB)'),
